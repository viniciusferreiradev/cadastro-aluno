...
if (isset($_POST['delete_student'])) {
    ...
    $query = "DELETE FROM estudantes WHERE id='$student_id' ";
...
if (isset($_POST['update_student'])) {
    ...
    $query = "UPDATE estudantes SET name='$name', email='$email', phone='$phone', course='$course' WHERE id='$student_id' ";
    $query_run = mysqli_query($con, $query);
...
if (isset($_POST['save_student'])) {
    ...
    $query = "INSERT INTO estudantes (name,email,phone,course) VALUES ('$name','$email','$phone','$course')";
